...
export default function Textbook() {
  ...
  function checkNav(event: React.SyntheticEvent) {
    if ((event.target as HTMLElement).dataset.part !== 'hardWords') {
      navigate(
        `${APP_ROUTES.TEXTBOOK}/${(event.target as HTMLElement).dataset.part}/${params.page}`
      );
    } else {
  ...
  return (
    <div>
      ...
      <ul className={styles.partList}>
        <li className={styles.partItem1} data-part="0" onClick={(event) => checkNav(event)}>
          Раздел 1
        </li>
        <li className={styles.partItem2} data-part="1" onClick={(event) => checkNav(event)}>
          Раздел 2
        </li>
        <li className={styles.partItem3} data-part="2" onClick={(event) => checkNav(event)}>
          Раздел 3
        </li>
        <li className={styles.partItem3} data-part="3" onClick={(event) => checkNav(event)}>
          Раздел 4
        </li>
        <li className={styles.partItem4} data-part="4" onClick={(event) => checkNav(event)}>
          Раздел 5
        </li>
